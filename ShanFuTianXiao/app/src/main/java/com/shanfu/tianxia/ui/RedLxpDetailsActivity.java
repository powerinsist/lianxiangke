...
public class RedLxpDetailsActivity extends BaseFragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_red_lxp_details);
    ...
    private void initData(){
        ...
        RedLxpAdapter adapter = new RedLxpAdapter(this,list);
