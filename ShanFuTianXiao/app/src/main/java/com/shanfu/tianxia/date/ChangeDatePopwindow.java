package com.shanfu.tianxia.date;
...
import com.shanfu.tianxia.date.wheelview.OnWheelChangedListener;
import com.shanfu.tianxia.date.wheelview.OnWheelScrollListener;
import com.shanfu.tianxia.date.wheelview.WheelView;
import com.shanfu.tianxia.date.wheelview.adapter.AbstractWheelTextAdapter1;
...
//Integer.parseInt(getYear())   + "年"
	public void initYears() {
		for (int i =2050 ; i > 2010; i--) {
			arry_years.add(i+"");
		}
	}
