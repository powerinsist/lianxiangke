...
public class MyRatingBar extends LinearLayout {
    ...
    public MyRatingBar(Context context, AttributeSet attrs) {
        ...
        starCount = mTypedArray.getInteger(R.styleable.MyRatingBar_starmyCount, 5);
        starEmptyDrawable = mTypedArray.getDrawable(R.styleable.MyRatingBar_starmyEmpty);
        starFillDrawable = mTypedArray.getDrawable(R.styleable.MyRatingBar_starmyFill);
