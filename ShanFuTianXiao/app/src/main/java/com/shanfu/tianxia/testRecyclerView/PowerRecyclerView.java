...
public class PowerRecyclerView extends RecyclerView implements View.OnTouchListener {
    ...
    /** 刷新控件 */
    private PowerRefreshView mRefresh;
    /** 加载更多控件 */
    private PowerLoadMoreView mLoadMore;
    /** 刷新控件布局对象 */
    ...
    private void init() {
        ...
        // 初始化刷新、加载控件
        mRefresh = new PowerRefreshView(getContext());
        mLoadMore = new PowerLoadMoreView(getContext());
        // 设置加载更多点击事件监听
