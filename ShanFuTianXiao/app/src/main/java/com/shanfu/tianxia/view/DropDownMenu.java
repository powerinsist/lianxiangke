...
import com.shanfu.tianxia.adapter.MenuListAdapter;
...
public class DropDownMenu extends LinearLayout {
    ...
    // Menu 展开的 list item
    private List<ArrayList<InitSearchBean.InitBean>> mMenuItems=new ArrayList<>();
    ...
    private void init(Context mContext){
        ...
        mPopupWindow = new PopupWindow(popWindows, LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT, true);
        ...
        mUpArrow=R.mipmap.arrow_up;
        mDownArrow=R.mipmap.arrow_down;

    }

    // 设置 Menu的item
    public void setmMenuItems(List<ArrayList<InitSearchBean.InitBean>> menuItems) {
        ...
        if (mDrawable) {
            ...
            mMenuList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                   ...
                   // mTvMenuTitles.get(mColumnSelected).setText(mMenuItems.get(mColumnSelected)[mRowSelected]);
                    mTvMenuTitles.get(mColumnSelected).setText(mMenuItems.get(mColumnSelected).get(mRowSelected).getName());
            ...
            for (int i = 0; i < mMenuCount; i++) {
                ...
                if (mDefaultMenuTitle==null||mDefaultMenuTitle.length==0){
                    tv.setText(mMenuItems.get(i).get(0).getName());
                }else{
