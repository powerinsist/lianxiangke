 ...
 */
public class InfoWindowActivity extends Activity implements OnClickListener, AMap.OnMarkerClickListener {
	...
	public boolean onMarkerClick(Marker marker) {
		...
		Toast.makeText(InfoWindowActivity.this, "您点击了Marker", Toast.LENGTH_LONG).show();
