...
import com.shanfu.tianxia.adapter.BrownLxpAdapter;
...
public class BrownLxpDetailsActivity extends BaseFragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brown_lxp_details);
    ...
    private void initData(){
        ...
        BrownLxpAdapter adapter = new BrownLxpAdapter(this,list);
