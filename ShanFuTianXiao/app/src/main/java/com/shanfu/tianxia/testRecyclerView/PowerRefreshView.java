...
public class PowerRefreshView extends StatusView {

    private TextView tv;
    private ImageView iv;

    public PowerRefreshView(@NonNull Context context) {
        super(context,null);
    }

    public PowerRefreshView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs,0);
    }

    public PowerRefreshView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
