...
/**
 * @author tardis_tao 
 * @version 创建时间：2016-11-11 下午3:13:00
 * @describe  APP相关信息工具类。获取版本信息      来源：https://github.com/jingle1267/android-utils
 */
            ...
            for (RunningAppProcessInfo process : processList) {
                ...
                if (process.importance > RunningAppProcessInfo.IMPORTANCE_VISIBLE) {
                    ...
                    for (String pkgName : pkgList) {
                        if (DEBUG) {
                           // LogUtil.d(TAG, "======正在杀死包名：" + pkgName);
                            //LogUtil.log(LogType.ERROR,get);
                        }
                        try {
