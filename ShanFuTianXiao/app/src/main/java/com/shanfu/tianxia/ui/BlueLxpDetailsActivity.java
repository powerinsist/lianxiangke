...
import com.shanfu.tianxia.adapter.BlueLxpAdapter;
...
public class BlueLxpDetailsActivity extends BaseFragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blue_lxp_details);
    ...
    private void initData(){
        ...
        BlueLxpAdapter adapter = new BlueLxpAdapter(this,list);
