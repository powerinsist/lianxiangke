...
public class BlueLxpAdapter extends BaseAdapter {

    private List<RedLxpBean> list;
    private Context context;
    public BlueLxpAdapter(Context context, List<RedLxpBean> list){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.layout_blue_detail_item,null,false);
