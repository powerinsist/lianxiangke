...
import com.shanfu.tianxia.adapter.GreenLxpAdapter;
...
public class GreenLxpDetailsActivity extends BaseFragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_green_lxp_details);
    ...
    private void initData(){
        ...
        GreenLxpAdapter adapter = new GreenLxpAdapter(this,list);
