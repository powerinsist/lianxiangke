...
public class BrownLxpAdapter extends BaseAdapter {

    private List<RedLxpBean> list;
    private Context context;

    public BrownLxpAdapter(Context context,List<RedLxpBean> list){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.layout_brown_detail_item,null,false);
